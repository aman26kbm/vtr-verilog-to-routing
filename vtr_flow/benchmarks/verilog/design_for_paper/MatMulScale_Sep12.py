...
#Sep 9:  remove the redunent reset and start_mat_mul signals
#		 remove the AND logic of done signals
#Sep 12: flop the data_from_out_mat
...
def write_with_ram(file, basic_block_size, final_block_size):
	...
	#for i in range(num_of_IO): Sep 9
