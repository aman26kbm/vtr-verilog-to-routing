...
wire [17:0] out1;
wire cout1;
	//r_counter + 13'b00000000000001;
adder_18bit u_add1(.a({5'b0, r_counter}), .b(18'b1), .cin(1'b0), .sumout(out1), .cout(cout1));

wire [17:0] out2;
wire cout2;
	//r_absorb_write_counter + 16'b0000000000000001;
adder_18bit u_add2(.a({2'b0, r_absorb_write_counter}), .b(18'b1), .cin(1'b0), .sumout(out2), .cout(cout2));

wire [17:0] out3;
wire cout3;
	//r_absorb_read_counter + 16'b01;
adder_18bit u_add3(.a({2'b0, r_absorb_read_counter}), .b(18'b1), .cin(1'b0), .sumout(out3), .cout(cout3));
...
*/
			...
			READ1_ST:
				begin			
					if(read_constants)
						...
						//c_counter = r_counter + 13'b00000000000001; // 13 bit + 13 bit (Adder 1)
						c_counter = out1[12:0];
			...
			READ2_ST:
				begin		
					...
					if(read_constants)
						begin
							wren_fres_up = 1'b1;
							//c_counter = r_counter + 13'b00000000000001; // 13 bit + 13 bit (Adder 2)
							c_counter = out1[12:0];
						//prevent latches
	...
	//	mem_layer = r_counter[12:10];
					if(read_constants)
						begin
							wren_fres_down = 1'b1;
							//c_counter = r_counter + 13'b00000000000001; // 13 bit + 13 bit (Adder 3)
							c_counter = out1[12:0];
							c_state = r_state;
						end
					else
		...
		mem_layer = r_counter[12:10];
					...
					if(read_constants)
						begin
							wren_cost = 1'b1;
							//c_counter = r_counter + 13'b00000000000001; // 13 bit + 13 bit (Adder 4)
							c_counter = out1[12:0];
							c_state = r_state;
						end
					else
		...
		mem_layer = r_counter[12:10];
					...
					if(read_constants)
						begin
							wren_sint = 1'b1;
							//c_counter = r_counter + 13'b00000000000000000000000001; // 13 bit + 13 bit (Adder 5)
							c_counter = out1[12:0];
							c_state = r_state;
							c_absorb_read_counter = r_absorb_read_counter;
					end
	...
	//	c_counter = r_counter;
		...
		mem_layer = r_counter[12:10];
				...
				c_counter = r_counter;
					...
					//c_absorb_write_counter = r_absorb_write_counter + 16'b0000000000000001; // 16 bit + 16 bit (Adder 6)
					c_absorb_write_counter = out2[15:0];
		...
		mem_layer = r_counter[12:10];
					...
					if(inc_result)
						...
						if(r_counter >= 13'b0000010001100) //104
							...
							begin
								//c_counter = r_counter + 13'b0000000000001; // 13 bit + 13 bit (Adder 7)
								c_counter = out1[12:0];
								c_state = DONE1_ST;
							end
						end
		...
		//mem_layer = r_counter[12:10];
					...
					c_result = 32'b0;
						if(inc_result)
						begin
								//c_counter = r_counter + 13'b0000000000001; // 13 bit + 13 bit (Adder 8)
								c_counter = out1[12:0];
								c_state = DONE1_ST;
						end
						else
		...
		//mem_layer = r_counter[12:10];
					...
					if(inc_result)
						begin
							...
							//c_counter = r_counter + 13'b0000000000001; // 13 bit + 13 bit (Adder 9)
							c_counter = out1[12:0];
							c_state = DONE3_ST;
						end
		...
		mem_layer = r_counter[12:10];
				...
				if(inc_result)
						begin
							// stub, write constants back to see if read in properly
						//c_counter = r_counter + 13'b0000000000001; // 13 bit + 13 bit (Adder 10)
						c_counter = out1[12:0];
						c_state = DONE4_ST;
						end
				else
		...
		mem_layer = r_counter[12:10];
					...
					if(r_counter >= 13'b1010000000000) //5*1024 = 5120
						...
						begin
							// stub, write constants back to see if read in properly
							//c_counter = r_counter + 13'b00000000000001; // 13 bit + 13 bit (Adder 11)
							c_counter = out1[12:0];
						end
						else
						begin
		...
		mem_layer = r_counter[12:10];
					...
					if(inc_result)
						begin
							...
							begin
								c_toggle = 1'b0;
								//c_absorb_read_counter = r_absorb_read_counter + 16'b01; // 16 bit + 16 bit (Adder 12)
								c_absorb_read_counter = out3[15:0];
							end
						end
					else
					begin
...
wire cout4;
//r_counter + 13'b00000000000001;
adder_18bit u_add4(.a({5'b0, r_counter}), .b(18'b1), .cin(1'b0), .sumout(out4), .cout(cout4));
...
begin
	...
	begin
		...
		begin
			//c_counter = r_counter + 1; //32 bit + 1  bit
			c_counter = out4[12:0];
			c_num_photons_left = r_num_photons_left;
		end
	end 
...
wire [31:0] dataa_temp;
wire [31:0] datab_temp;

assign dataa_temp = ~dataa;
assign datab_temp = ~datab;

wire [31:0] out5;
wire cout5;
adder_32bit u_add5(.a(dataa_temp), .b(32'b00000000000000000000000000000001), .cin(1'b0), .sumout(out5), .cout(cout5));

wire [31:0] out6;
wire cout6;
adder_32bit u_add6(.a(datab_temp), .b(32'b00000000000000000000000000000001), .cin(1'b0), .sumout(out6), .cout(cout6));
	
	//assign opa_comp =  ((~dataa) + 32'b00000000000000000000000000000001); //32 bit + 32 bit 
	assign opa_comp = out5;

	//assign opb_comp =  ((~datab) + 32'b00000000000000000000000000000001); //32 bit + 32 bit 
	assign opb_comp = out6;
	...
	wire [63:0] prelim_resul_temp;
	assign prelim_resul_temp = ~prelim_result;
	wire [63:0] out7;
	wire cout7;
	adder_64bit u_add7(.a(prelim_resul_temp), .b(64'b1), .cin(1'b0), .sumout(out7), .cout(cout7));
	//assign prelim_result_comp =  ((~prelim_result) + 1); //64 bit + 1 bit
	assign prelim_result_comp = out7;
...
wire [31:0] out8;
wire cout8;
adder_32bit u_add8(.a(x_boundaryChecker), .b(c_xmult_big[2*`BIT_WIDTH-2:31]), .cin(1'b0), .sumout(out8), .cout(cout8));


wire [31:0] out9;
wire cout9;
adder_32bit u_add9(.a(y_boundaryChecker), .b(c_xmult_big[2*`BIT_WIDTH-2:31]), .cin(1'b0), .sumout(out9), .cout(cout9));


wire [31:0] out10;
wire cout10;
adder_32bit u_add10(.a(z_boundaryChecker), .b(c_xmult_big[2*`BIT_WIDTH-2:31]), .cin(1'b0), .sumout(out10), .cout(cout10));
...
begin
	...
	//c_x_big = x_boundaryChecker + c_xmult_big[2*`BIT_WIDTH-2:31]; // 32 bit + 32 bit 
	//c_y_big = y_boundaryChecker + c_ymult_big[2*`BIT_WIDTH-2:31]; // 32 bit + 32 bit 
	//c_z_big = z_boundaryChecker + c_zmult_big[2*`BIT_WIDTH-2:31]; // 32 bit + 32 bit 
	 c_x_big = out8;
	 c_y_big = out9;
	 c_z_big = out10;
...
//Need constant shift
wire [5:0]shifted;
assign shifted = c_indexFirstOne - `MANTISSA_PRECISION + 1; //ignore
...
wire [31:0] temp1_c_log;
wire [31:0] temp2_c_log;

wire [31:0] out30;
wire cout30;
adder_32bit u_add30(.a(mantissa), .b(temp1_c_log), .cin(1'b0), .sumout(out30), .cout(cout30));

wire [31:0] out31;
wire cout31;
adder_32bit u_add31(.a(temp2_c_log), .b(out30), .cin(1'b0), .sumout(out31), .cout(cout31));
...
begin
	...
	begin 
		//c_log_x =  mantissa - ((`MANTISSA_PRECISION - 1) * `LOG2) + (r_indexFirstOne * `LOG2); //32 bit - 4 bit*27bit  + 5 bit * 27 bit
		temp1_c_log = (`MANTISSA_PRECISION - 1) * `LOG2;
		temp2_c_log = r_indexFirstOne * `LOG2;
		c_log_x = out31;
	end
	else
	begin
...
wire [63:0] out32;
wire cout32;
adder_64bit u_add32(.a(x2_P), .b(y2_P), .cin(1'b0), .sumout(out32), .cout(cout32));
...
always @(reset or x2_P or y2_P) begin
	if (reset)
		...
		//r2_temp=x2_P+y2_P; //64 bit + 64 bit 
		r2_temp = out32;
end
...
//		end
 	...
 	wire [17:0] out33;
	wire cout33;
	adder_18bit u_add33(.a({2'b0, ir_scaled[15:0]}), .b({2'b0, iz_P[15:0]}), .cin(1'b0), .sumout(out33), .cout(cout33));
...
always @(reset or ir__15 or iz__15 or ir_P or iz_P or ir_scaled) begin
	if (reset) begin
      ...
      //rADDR_temp=ir_scaled[15:0] + iz_P[15:0]; 		//16 bit + 16 bit 
	  rADDR_temp= out33[15:0];
   end
end
...
wire [31:0] out34;
wire cout34;
adder_32bit u_add34(.a(weight_P), .b(dwa_P), .cin(1'b0), .sumout(out34), .cout(cout34));

wire [63:0] out35;
wire cout35;
adder_64bit u_add35(.a(oldAbs_P), .b({32'b0, dwa_P}), .cin(1'b0), .sumout(out35), .cout(cout35));
...
always @(reset or dwa__17 or weight__17 or weight_P or dwa_P or oldAbs_P) begin
	if(reset) begin
	   ...
	   dwa_P=dwa__17;
	   weight_P=weight__17; 
		//newWeight=weight_P-dwa_P; //32 bit - 32 bit 
		newWeight = out34;
	...
	//TRANSMITTED
		...
		0:begin//uz >= 0
			if (i_layer36 == 5) begin
				...
				new_layer	= i_layer36+3'h1; //ignore
				new_dead	= i_dead36;
			end
			new_uz			= uz2__37;
		end
...
wire [63:0] out36;
wire cout36;
adder_64bit u_add36(.a(dataa), .b(datab), .cin(1'b0), .sumout(out36), .cout(cout36));
	...
	//assign computation = dataa + datab; //64 bit + 64 bit 
	assign computation = out36;
...
/* 	assign op__0 = num;
	...
	wire [63:0] res__0_temp;
	
	assign res__0_temp = res__0 >> 1;
	
	adder_64bit u_add000(.a(res__0), .b(one__0), .cin(1'b0), .sumout(out000), .cout(cout000));
	adder_64bit u_add001(.a(op__0), .b(res__0), .cin(1'b0), .sumout(out001), .cout(cout001));
	adder_64bit u_add002(.a(out001), .b(one__0), .cin(1'b0), .sumout(out002), .cout(cout002));
	adder_64bit u_add003(.a(res__0_temp), .b(one__0), .cin(1'b0), .sumout(out003), .cout(cout003)); */
...
wire [63:0] res__1_temp;

assign res__1_temp  = res__1 >> 1 ; 

adder_64bit u_add100(.a(res__1), .b(one__1), .cin(1'b0), .sumout(out100), .cout(cout100));
adder_64bit u_add101(.a(op__1), .b(res__1), .cin(1'b0), .sumout(out101), .cout(cout101));
adder_64bit u_add102(.a(out101), .b(one__1), .cin(1'b0), .sumout(out102), .cout(cout102));
adder_64bit u_add103(.a(res__1_temp), .b(one__1), .cin(1'b0), .sumout(out103), .cout(cout103));
...
wire [63:0] res__2_temp;

assign res__2_temp  = res__2 >> 1 ; 

adder_64bit u_add200(.a(res__2), .b(one__2), .cin(1'b0), .sumout(out200), .cout(cout200));
adder_64bit u_add201(.a(op__2), .b(res__2), .cin(1'b0), .sumout(out201), .cout(cout201));
adder_64bit u_add202(.a(out201), .b(one__2), .cin(1'b0), .sumout(out202), .cout(cout202));
adder_64bit u_add203(.a(res__2_temp), .b(one__2), .cin(1'b0), .sumout(out203), .cout(cout203));
...
wire [63:0] res__3_temp;

assign res__3_temp  = res__3_q >> 1 ; 

adder_64bit u_add300(.a(res__3_q), .b(one__3_q), .cin(1'b0), .sumout(out300), .cout(cout300));
adder_64bit u_add301(.a(op__3_q), .b(res__3_q), .cin(1'b0), .sumout(out301), .cout(cout301));
adder_64bit u_add302(.a(out301), .b(one__3_q), .cin(1'b0), .sumout(out302), .cout(cout302));
adder_64bit u_add303(.a(res__3_temp), .b(one__3_q), .cin(1'b0), .sumout(out303), .cout(cout303));
...
wire [63:0] res__4_temp;

assign res__4_temp  = res__4 >> 1 ; 

adder_64bit u_add400(.a(res__4), .b(one__4), .cin(1'b0), .sumout(out400), .cout(cout400));
adder_64bit u_add401(.a(op__4), .b(res__4), .cin(1'b0), .sumout(out401), .cout(cout401));
adder_64bit u_add402(.a(out401), .b(one__4), .cin(1'b0), .sumout(out402), .cout(cout402));
adder_64bit u_add403(.a(res__4_temp), .b(one__4), .cin(1'b0), .sumout(out403), .cout(cout403));
...
wire [63:0] res__5_temp;

assign res__5_temp  = res__5 >> 1 ; 

adder_64bit u_add500(.a(res__5), .b(one__5), .cin(1'b0), .sumout(out500), .cout(cout500));
adder_64bit u_add501(.a(op__5), .b(res__5), .cin(1'b0), .sumout(out501), .cout(cout501));
adder_64bit u_add502(.a(out501), .b(one__5), .cin(1'b0), .sumout(out502), .cout(cout502));
adder_64bit u_add503(.a(res__5_temp), .b(one__5), .cin(1'b0), .sumout(out503), .cout(cout503));
...
wire [63:0] res__6_temp;

assign res__6_temp  = res__6 >> 1 ; 

adder_64bit u_add600(.a(res__6), .b(one__6), .cin(1'b0), .sumout(out600), .cout(cout600));
adder_64bit u_add601(.a(op__6), .b(res__6), .cin(1'b0), .sumout(out601), .cout(cout601));
adder_64bit u_add602(.a(out601), .b(one__6), .cin(1'b0), .sumout(out602), .cout(cout602));
adder_64bit u_add603(.a(res__6_temp), .b(one__6), .cin(1'b0), .sumout(out603), .cout(cout603));
...
wire [63:0] res__7_temp;

assign res__7_temp  = res__7_q >> 1 ; 

adder_64bit u_add700(.a(res__7_q), .b(one__7_q), .cin(1'b0), .sumout(out700), .cout(cout700));
adder_64bit u_add701(.a(op__7_q), .b(res__7_q), .cin(1'b0), .sumout(out701), .cout(cout701));
adder_64bit u_add702(.a(out701), .b(one__7_q), .cin(1'b0), .sumout(out702), .cout(cout702));
adder_64bit u_add703(.a(res__7_temp), .b(one__7_q), .cin(1'b0), .sumout(out703), .cout(cout703));
...
wire [63:0] res__8_temp;

assign res__8_temp  = res__8 >> 1 ; 

adder_64bit u_add800(.a(res__8), .b(one__8), .cin(1'b0), .sumout(out800), .cout(cout800));
adder_64bit u_add801(.a(op__8), .b(res__8), .cin(1'b0), .sumout(out801), .cout(cout801));
adder_64bit u_add802(.a(out801), .b(one__8), .cin(1'b0), .sumout(out802), .cout(cout802));
adder_64bit u_add803(.a(res__8_temp), .b(one__8), .cin(1'b0), .sumout(out803), .cout(cout803));
...
wire [63:0] res__9_temp;

assign res__9_temp  = res__9 >> 1 ; 

adder_64bit u_add900(.a(res__9), .b(one__9), .cin(1'b0), .sumout(out900), .cout(cout900));
adder_64bit u_add901(.a(op__9), .b(res__9), .cin(1'b0), .sumout(out901), .cout(cout901));
adder_64bit u_add902(.a(out901), .b(one__9), .cin(1'b0), .sumout(out902), .cout(cout902));
adder_64bit u_add903(.a(res__9_temp), .b(one__9), .cin(1'b0), .sumout(out903), .cout(cout903));
...
wire [63:0] res__10_temp;

assign res__10_temp  = res__10 >> 1 ; 

adder_64bit u_add1000(.a(res__10), .b(one__10), .cin(1'b0), .sumout(out1000), .cout(cout1000));
adder_64bit u_add1001(.a(op__10), .b(res__10), .cin(1'b0), .sumout(out1001), .cout(cout1001));
adder_64bit u_add1002(.a(out1001), .b(one__10), .cin(1'b0), .sumout(out1002), .cout(cout1002));
adder_64bit u_add1003(.a(res__10_temp), .b(one__10), .cin(1'b0), .sumout(out1003), .cout(cout1003));
...
wire [63:0] res__11_temp;

assign res__11_temp  = res__11_q >> 1 ; 

adder_64bit u_add1100(.a(res__11_q), .b(one__11_q), .cin(1'b0), .sumout(out1100), .cout(cout1100));
adder_64bit u_add1101(.a(op__11_q), .b(res__11_q), .cin(1'b0), .sumout(out1101), .cout(cout1101));
adder_64bit u_add1102(.a(out1101), .b(one__11_q), .cin(1'b0), .sumout(out1102), .cout(cout1102));
adder_64bit u_add1103(.a(res__11_temp), .b(one__11_q), .cin(1'b0), .sumout(out1103), .cout(cout1103));
...
wire [63:0] res__12_temp;

assign res__12_temp  = res__12 >> 1 ; 

adder_64bit u_add1200(.a(res__12), .b(one__12), .cin(1'b0), .sumout(out1200), .cout(cout1200));
adder_64bit u_add1201(.a(op__12), .b(res__12), .cin(1'b0), .sumout(out1201), .cout(cout1201));
adder_64bit u_add1202(.a(out1201), .b(one__12), .cin(1'b0), .sumout(out1202), .cout(cout1202));
adder_64bit u_add1203(.a(res__12_temp), .b(one__12), .cin(1'b0), .sumout(out1203), .cout(cout1203));
...
wire [63:0] res__13_temp;

assign res__13_temp  = res__13 >> 1 ; 

adder_64bit u_add1300(.a(res__13), .b(one__13), .cin(1'b0), .sumout(out1300), .cout(cout1300));
adder_64bit u_add1301(.a(op__13), .b(res__13), .cin(1'b0), .sumout(out1301), .cout(cout1301));
adder_64bit u_add1302(.a(out1301), .b(one__13), .cin(1'b0), .sumout(out1302), .cout(cout1302));
adder_64bit u_add1303(.a(res__13_temp), .b(one__13), .cin(1'b0), .sumout(out1303), .cout(cout1303));
...
wire [63:0] res__14_temp;

assign res__14_temp  = res__14 >> 1 ; 

adder_64bit u_add1400(.a(res__14), .b(one__14), .cin(1'b0), .sumout(out1400), .cout(cout1400));
adder_64bit u_add1401(.a(op__14), .b(res__14), .cin(1'b0), .sumout(out1401), .cout(cout1401));
adder_64bit u_add1402(.a(out1401), .b(one__14), .cin(1'b0), .sumout(out1402), .cout(cout1402));
adder_64bit u_add1403(.a(res__14_temp), .b(one__14), .cin(1'b0), .sumout(out1403), .cout(cout1403));
...
wire [63:0] res__15_temp;

assign res__15_temp  = res__15_q >> 1 ; 

adder_64bit u_add1500(.a(res__15_q), .b(one__15_q), .cin(1'b0), .sumout(out1500), .cout(cout1500));
adder_64bit u_add1501(.a(op__15_q), .b(res__15_q), .cin(1'b0), .sumout(out1501), .cout(cout1501));
adder_64bit u_add1502(.a(out1501), .b(one__15_q), .cin(1'b0), .sumout(out1502), .cout(cout1502));
adder_64bit u_add1503(.a(res__15_temp), .b(one__15_q), .cin(1'b0), .sumout(out1503), .cout(cout1503));
...
wire [63:0] res__16_temp;

assign res__16_temp  = res__16 >> 1 ; 

adder_64bit u_add1600(.a(res__16), .b(one__16), .cin(1'b0), .sumout(out1600), .cout(cout1600));
adder_64bit u_add1601(.a(op__16), .b(res__16), .cin(1'b0), .sumout(out1601), .cout(cout1601));
adder_64bit u_add1602(.a(out1601), .b(one__16), .cin(1'b0), .sumout(out1602), .cout(cout1602));
adder_64bit u_add1603(.a(res__16_temp), .b(one__16), .cin(1'b0), .sumout(out1603), .cout(cout1603));
...
wire [63:0] res__17_temp;

assign res__17_temp  = res__17 >> 1 ; 

adder_64bit u_add1700(.a(res__17), .b(one__17), .cin(1'b0), .sumout(out1700), .cout(cout1700));
adder_64bit u_add1701(.a(op__17), .b(res__17), .cin(1'b0), .sumout(out1701), .cout(cout1701));
adder_64bit u_add1702(.a(out1701), .b(one__17), .cin(1'b0), .sumout(out1702), .cout(cout1702));
adder_64bit u_add1703(.a(res__17_temp), .b(one__17), .cin(1'b0), .sumout(out1703), .cout(cout1703));
...
wire [63:0] res__18_temp;

assign res__18_temp  = res__18_q >> 1 ; 

adder_64bit u_add1800(.a(res__18_q), .b(one__18_q), .cin(1'b0), .sumout(out1800), .cout(cout1800));
adder_64bit u_add1801(.a(op__18_q), .b(res__18_q), .cin(1'b0), .sumout(out1801), .cout(cout1801));
adder_64bit u_add1802(.a(out1801), .b(one__18_q), .cin(1'b0), .sumout(out1802), .cout(cout1802));
adder_64bit u_add1803(.a(res__18_temp), .b(one__18_q), .cin(1'b0), .sumout(out1803), .cout(cout1803));
...
wire [63:0] res__19_temp;

assign res__19_temp  = res__19 >> 1 ; 

adder_64bit u_add1900(.a(res__19), .b(one__19), .cin(1'b0), .sumout(out1900), .cout(cout1900));
adder_64bit u_add1901(.a(op__19), .b(res__19), .cin(1'b0), .sumout(out1901), .cout(cout1901));
adder_64bit u_add1902(.a(out1901), .b(one__19), .cin(1'b0), .sumout(out1902), .cout(cout1902));
adder_64bit u_add1903(.a(res__19_temp), .b(one__19), .cin(1'b0), .sumout(out1903), .cout(cout1903));
...
wire [63:0] res__20_temp;

assign res__20_temp  = res__20 >> 1 ; 

adder_64bit u_add2000(.a(res__20), .b(one__20), .cin(1'b0), .sumout(out2000), .cout(cout2000));
adder_64bit u_add2001(.a(op__20), .b(res__20), .cin(1'b0), .sumout(out2001), .cout(cout2001));
adder_64bit u_add2002(.a(out2001), .b(one__20), .cin(1'b0), .sumout(out2002), .cout(cout2002));
adder_64bit u_add2003(.a(res__20_temp), .b(one__20), .cin(1'b0), .sumout(out2003), .cout(cout2003));
...
wire [63:0] res__21_temp;

assign res__21_temp  = res__21_q >> 1 ; 

adder_64bit u_add2100(.a(res__21_q), .b(one__21_q), .cin(1'b0), .sumout(out2100), .cout(cout2100));
adder_64bit u_add2101(.a(op__21_q), .b(res__21_q), .cin(1'b0), .sumout(out2101), .cout(cout2101));
adder_64bit u_add2102(.a(out2101), .b(one__21_q), .cin(1'b0), .sumout(out2102), .cout(cout2102));
adder_64bit u_add2103(.a(res__21_temp), .b(one__21_q), .cin(1'b0), .sumout(out2103), .cout(cout2103));
...
wire [63:0] res__22_temp;

assign res__22_temp  = res__22 >> 1 ; 

adder_64bit u_add2200(.a(res__22), .b(one__22), .cin(1'b0), .sumout(out2200), .cout(cout2200));
adder_64bit u_add2201(.a(op__22), .b(res__22), .cin(1'b0), .sumout(out2201), .cout(cout2201));
adder_64bit u_add2202(.a(out2201), .b(one__22), .cin(1'b0), .sumout(out2202), .cout(cout2202));
adder_64bit u_add2203(.a(res__22_temp), .b(one__22), .cin(1'b0), .sumout(out2203), .cout(cout2203));
...
wire [63:0] res__23_temp;

assign res__23_temp  = res__23 >> 1 ; 

adder_64bit u_add2300(.a(res__23), .b(one__23), .cin(1'b0), .sumout(out2300), .cout(cout2300));
adder_64bit u_add2301(.a(op__23), .b(res__23), .cin(1'b0), .sumout(out2301), .cout(cout2301));
adder_64bit u_add2302(.a(out2301), .b(one__23), .cin(1'b0), .sumout(out2302), .cout(cout2302));
adder_64bit u_add2303(.a(res__23_temp), .b(one__23), .cin(1'b0), .sumout(out2303), .cout(cout2303));
...
wire [63:0] res__24_temp;

assign res__24_temp  = res__24_q >> 1 ; 

adder_64bit u_add2400(.a(res__24_q), .b(one__24_q), .cin(1'b0), .sumout(out2400), .cout(cout2400));
adder_64bit u_add2401(.a(op__24_q), .b(res__24_q), .cin(1'b0), .sumout(out2401), .cout(cout2401));
adder_64bit u_add2402(.a(out2401), .b(one__24_q), .cin(1'b0), .sumout(out2402), .cout(cout2402));
adder_64bit u_add2403(.a(res__24_temp), .b(one__24_q), .cin(1'b0), .sumout(out2403), .cout(cout2403));
...
wire [63:0] res__25_temp;

assign res__25_temp  = res__25 >> 1 ; 

adder_64bit u_add2500(.a(res__25), .b(one__25), .cin(1'b0), .sumout(out2500), .cout(cout2500));
adder_64bit u_add2501(.a(op__25), .b(res__25), .cin(1'b0), .sumout(out2501), .cout(cout2501));
adder_64bit u_add2502(.a(out2501), .b(one__25), .cin(1'b0), .sumout(out2502), .cout(cout2502));
adder_64bit u_add2503(.a(res__25_temp), .b(one__25), .cin(1'b0), .sumout(out2503), .cout(cout2503));
...
wire [63:0] res__26_temp;

assign res__26_temp  = res__26 >> 1 ; 

adder_64bit u_add2600(.a(res__26), .b(one__26), .cin(1'b0), .sumout(out2600), .cout(cout2600));
adder_64bit u_add2601(.a(op__26), .b(res__26), .cin(1'b0), .sumout(out2601), .cout(cout2601));
adder_64bit u_add2602(.a(out2601), .b(one__26), .cin(1'b0), .sumout(out2602), .cout(cout2602));
adder_64bit u_add2603(.a(res__26_temp), .b(one__26), .cin(1'b0), .sumout(out2603), .cout(cout2603));
...
wire [63:0] res__27_temp;

assign res__27_temp  = res__27_q >> 1 ; 

adder_64bit u_add2700(.a(res__27_q), .b(one__27_q), .cin(1'b0), .sumout(out2700), .cout(cout2700));
adder_64bit u_add2701(.a(op__27_q), .b(res__27_q), .cin(1'b0), .sumout(out2701), .cout(cout2701));
adder_64bit u_add2702(.a(out2701), .b(one__27_q), .cin(1'b0), .sumout(out2702), .cout(cout2702));
adder_64bit u_add2703(.a(res__27_temp), .b(one__27_q), .cin(1'b0), .sumout(out2703), .cout(cout2703));
...
wire [63:0] res__28_temp;

assign res__28_temp  = res__28 >> 1 ; 

adder_64bit u_add2800(.a(res__28), .b(one__28), .cin(1'b0), .sumout(out2800), .cout(cout2800));
adder_64bit u_add2801(.a(op__28), .b(res__28), .cin(1'b0), .sumout(out2801), .cout(cout2801));
adder_64bit u_add2802(.a(out2801), .b(one__28), .cin(1'b0), .sumout(out2802), .cout(cout2802));
adder_64bit u_add2803(.a(res__28_temp), .b(one__28), .cin(1'b0), .sumout(out2803), .cout(cout2803));
...
wire [63:0] res__29_temp;

assign res__29_temp  = res__29 >> 1 ; 

adder_64bit u_add2900(.a(res__29), .b(one__29), .cin(1'b0), .sumout(out2900), .cout(cout2900));
adder_64bit u_add2901(.a(op__29), .b(res__29), .cin(1'b0), .sumout(out2901), .cout(cout2901));
adder_64bit u_add2902(.a(out2901), .b(one__29), .cin(1'b0), .sumout(out2902), .cout(cout2902));
adder_64bit u_add2903(.a(res__29_temp), .b(one__29), .cin(1'b0), .sumout(out2903), .cout(cout2903));
...
wire [63:0] res__30_temp;

assign res__30_temp  = res__30_q >> 1 ; 

adder_64bit u_add3000(.a(res__30_q), .b(one__30_q), .cin(1'b0), .sumout(out3000), .cout(cout3000));
adder_64bit u_add3001(.a(op__30_q), .b(res__30_q), .cin(1'b0), .sumout(out3001), .cout(cout3001));
adder_64bit u_add3002(.a(out3001), .b(one__30_q), .cin(1'b0), .sumout(out3002), .cout(cout3002));
adder_64bit u_add3003(.a(res__30_temp), .b(one__30_q), .cin(1'b0), .sumout(out3003), .cout(cout3003));
...
wire [63:0] res__31_temp;

assign res__31_temp  = res__31 >> 1 ; 

adder_64bit u_add3100(.a(res__31), .b(one__31), .cin(1'b0), .sumout(out3100), .cout(cout3100));
adder_64bit u_add3101(.a(op__31), .b(res__31), .cin(1'b0), .sumout(out3101), .cout(cout3101));
adder_64bit u_add3102(.a(out3101), .b(one__31), .cin(1'b0), .sumout(out3102), .cout(cout3102));
adder_64bit u_add3103(.a(res__31_temp), .b(one__31), .cin(1'b0), .sumout(out3103), .cout(cout3103));
...
one__32 = (one__31 >> 2 ); 
 ...
 module adder_18bit(
  ...
  mult_add_sum_int u3 (.ax(19'b0), .ay(a[17:0]),  .bx(19'b0), .by(b[17:0]), .chainin({37'b0, cin}), .resulta(sum_lower_16) , .chainout(chainout_1), .mode_sigs(11'b0));
...
module adder_64bit(
  ...
  wire [31:0] sum_lower_16;
  wire [31:0] sum_higher_16;
  wire cout_1;
  
adder_32bit u11 ( .a(a[31:0]) , .b(b[31:0]), .cin (cin), .sumout(sum_lower_16), .cout(cout_1));
adder_32bit u12 ( .a(a[63:32]) , .b(b[63:32]), .cin (cout_1), .sumout(sum_higher_16), .cout(cout));
