...
matmul_int8 u_matmul_8x8_systolic_0_2(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_0_3(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_1_2(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_1_3(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_2_0(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_2_1(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_2_2(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_2_3(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_3_0(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_3_1(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_3_2(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
matmul_int8 u_matmul_8x8_systolic_3_3(
  .clk(clk),
  .reset(reset),
  .pe_reset(pe_reset),
  .start_mat_mul(start_mat_mul),
...
//we hardcode them at the instantiation level.
 ...
 assign b_loc_NC = b_loc;
    ...
    assign a_addr = bram_addr_a_0_0 | bram_addr_a_1_0 | bram_addr_a_2_0 | bram_addr_a_3_0;  //fake OR to avoid ODIN optimization
    assign b_addr = bram_addr_b_0_0 | bram_addr_b_0_1 | bram_addr_b_0_2 | bram_addr_b_0_3;  //fake OR to avoid ODIN optimization
...
assign c_data_available = c_data_0_3_available | c_data_1_3_available | c_data_2_3_available | c_data_3_3_available; //fake ORing to prevent ODIN optimization
assign c_addr = bram_addr_c_0_3 | bram_addr_c_1_3 | bram_addr_c_2_3 | bram_addr_c_3_3;//fake ORing to prevent ODIN optimization
