  ...
  def generate_dirs(self):
    ...
    for line in dirs:
      ...
      if fpga_arch == "matmul.pct3":
        arch_file = "agilex.matmul.3pct.for_temp_use.xml"
      elif fpga_arch == "matmul.pct6":
        arch_file = "agilex.matmul.6pct.for_temp_use.xml"
      elif fpga_arch == "matmul.pct9":
        arch_file = "agilex.matmul.9pct.for_temp_use.xml"
      elif fpga_arch == "dsp":
        arch_file = "agilex.dsp.for_temp_use.xml"
      else:
