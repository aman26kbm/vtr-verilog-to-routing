    ...
    for line in infile:
      ...
      if not found:
        ...
        for line in vpr_out:
          ...
          if crit_path_match1 is not None or crit_path_match2 is not None or crit_path_match3 is not None or crit_path_match4 is not None or crit_path_match5 is not None:
            ...
            if crit_path_match5 is not None:
              crit_path_match = crit_path_match5
