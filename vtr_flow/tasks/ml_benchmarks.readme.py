...
#    fh.close()
    ...
    fh = open(filename, "w")
    for i in range(3):
        fh.write('python3 ../../scripts/run_vtr_task.py -l task_list_exp{e}.shorter -j 6 -s --seed {seed}\n'.format(e=exp,seed=str(random.randint(1,10000))))
    fh.write("echo '----- All runs completed -----\\n'\n")
    fh.close()
...
#--------------------------
    ...
    fh = open(filename, "w")
    #fh.write('nohup ./cmds.mar_2021.exp{e}.larger > log.mar22.exp{e}.larger &\n'.format(e=exp))
    #fh.write('nohup ./cmds.mar_2021.exp{e} > log.mar22.exp{e} &\n'.format(e=exp))
    fh.write('nohup ./cmds.mar_2021.exp{e}.shorter > log.mar22.exp{e}.shorter &\n'.format(e=exp))
    fh.close()
...
#--------------------------
    ...
    fh = open(filename, "w")
    #fh.write('python3 ../gen_results.fixed_w.mar_2021.py -i log.mar22.exp{e}.larger -o out.mar22.exp{e}.larger.csv -t exp{e}\n'.format(e=exp))
    #fh.write('python3 ../gen_results.fixed_w.mar_2021.py -i log.mar22.exp{e} -o out.mar22.exp{e}.csv -t exp{e}\n'.format(e=exp))
    fh.write('python3 ../gen_results.fixed_w.mar_2021.py -i log.mar22.exp{e}.shorter -o out.mar22.exp{e}.shorter.csv -t exp{e}\n'.format(e=exp))
    fh.close()
